...
if __name__ == "__main__":
    ...
    print("COCO: ",
          anno_yolo_coco(yolo_ex["x_center"], yolo_ex["y_center"], yolo_ex["width"], yolo_ex["height"], 640, 480))
    print("VOC: ",
          anno_yolo_voc(yolo_ex["x_center"], yolo_ex["y_center"], yolo_ex["width"], yolo_ex["height"], 640, 480))
